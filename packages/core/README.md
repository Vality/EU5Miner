...
- Migration notes for the workspace consolidation: [RENAMING.md](../../RENAMING.md)
- Execution-ready work packages: [documents/specs/README.md](../../documents/core/README.md)
- Architecture constraints and layering rules: [documents/architecture.md](../../documents/architecture.md)
- Developer environment notes for the OneDrive/`uv` workflow: [documents/development-environment.md](../../documents/development-environment.md)
- `1.0` boundary and blocker set: [documents/v1-scope.md](../../documents/v1-scope.md) and [documents/v1-release-readiness.md](../../documents/v1-release-readiness.md)
