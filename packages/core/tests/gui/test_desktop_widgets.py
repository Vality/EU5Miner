...
def _install_fake_visual_modules(monkeypatch: pytest.MonkeyPatch) -> None:
    visuals = ModuleType("eu5miner.gui.desktop.widgets.visuals")
    ...
    monkeypatch.setitem(sys.modules, "eu5miner.gui.desktop.widgets.visuals", visuals)
...
def _load_page_host_stack(monkeypatch: pytest.MonkeyPatch):
    ...
    overview_module = ModuleType("eu5miner.gui.desktop.widgets.overview_page")
    ...
    monkeypatch.setitem(sys.modules, "eu5miner.gui.desktop.widgets.overview_page", overview_module)

    report_module = ModuleType("eu5miner.gui.desktop.widgets.report_page")
    ...
    monkeypatch.setitem(sys.modules, "eu5miner.gui.desktop.widgets.report_page", report_module)

    entity_module = ModuleType("eu5miner.gui.desktop.widgets.entity_browser_page")
    ...
    monkeypatch.setitem(
        sys.modules,
        "eu5miner.gui.desktop.widgets.entity_browser_page",
        entity_module,
    )

    for module_name in (
        "eu5miner.gui.desktop.widgets.page_host",
        "eu5miner.gui.desktop.widgets.sidebar",
        "eu5miner.gui.desktop.widgets.source_bar",
    ):
        sys.modules.pop(module_name, None)

    page_host = importlib.import_module("eu5miner.gui.desktop.widgets.page_host")
    sidebar = importlib.import_module("eu5miner.gui.desktop.widgets.sidebar")
    source_bar = importlib.import_module("eu5miner.gui.desktop.widgets.source_bar")
...
def _load_entity_browser_module(monkeypatch: pytest.MonkeyPatch):
    ...
    sys.modules.pop("eu5miner.gui.desktop.widgets.entity_browser_page", None)
    return importlib.import_module("eu5miner.gui.desktop.widgets.entity_browser_page")


def _load_sidebar_module(monkeypatch: pytest.MonkeyPatch):
    _install_fake_kivy(monkeypatch)
    _install_fake_visual_modules(monkeypatch)
    sys.modules.pop("eu5miner.gui.desktop.widgets.sidebar", None)
    return importlib.import_module("eu5miner.gui.desktop.widgets.sidebar")
