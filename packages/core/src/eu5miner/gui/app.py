...
from eu5miner.gui.browser import (
    build_browser_model,
    parse_browser_page_selection,
    render_browser_model,
)
from eu5miner.gui.desktop.bootstrap import DesktopLaunchOptions, launch_desktop_app
from eu5miner.gui.desktop.navigation import NavigationTarget, navigation_target_from_page_key
from eu5miner.gui.diplomacy_helpers import list_diplomacy_helpers
from eu5miner.gui.religion_helpers import list_religion_helpers
