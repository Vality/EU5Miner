...
def launch_desktop_app(
    *,
    ...
    from eu5miner.gui.desktop.widgets.page_host import PageHost
    from eu5miner.gui.desktop.widgets.sidebar import Sidebar
    from eu5miner.gui.desktop.widgets.source_bar import SourceBar
