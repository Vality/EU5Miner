...
from eu5miner.gui.diplomacy_helpers import DiplomacyHelperInfo, DiplomacyHelperView
from eu5miner.gui.religion_helpers import ReligionHelperInfo, ReligionHelperView
