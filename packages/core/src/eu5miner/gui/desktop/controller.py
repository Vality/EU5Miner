...
from eu5miner.gui.desktop.adapters import (
...
from eu5miner.gui.desktop.navigation import NavigationTarget, SidebarItem, SidebarSection
from eu5miner.gui.desktop.state import (
...
from eu5miner.gui.diplomacy_helpers import (
    DiplomacyHelperInfo,
    build_diplomacy_helper_view,
    list_diplomacy_helpers,
)
from eu5miner.gui.religion_helpers import (
    ReligionHelperInfo,
