...
Use this repository as a typed Python application built on top of the `eu5miner` library.
...
- Prefer thin UI-facing integrations over duplicating backend behavior.
