...
- add one MCP-local diplomacy tool module at `src/eu5miner.mcp/tools/diplomacy.py`
...
- `src/eu5miner.mcp/tools/diplomacy.py`
- `src/eu5miner.mcp/tools/__init__.py`
- `src/eu5miner.mcp/server.py`
- `src/eu5miner.mcp/serializers.py`
