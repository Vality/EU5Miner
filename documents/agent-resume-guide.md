...
The reusable scripted logic phase is now complete enough to move into the next major domain family. The next recommended domain target is `building types and building categories`, followed by the rest of the economy and production systems.
