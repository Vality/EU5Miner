...
The diplomacy and warfare layer now includes typed adapters for `common/casus_belli/*.txt`, `common/wargoals/*.txt`, `common/peace_treaties/*.txt`, `common/subject_types/*.txt`, `common/subject_military_stances/*.txt`, `common/country_interactions/*.txt`, `common/character_interactions/*.txt`, `common/unit_types/*.txt`, `common/unit_abilities/*.txt`, and `common/unit_categories/*.txt`. The government and society phase now includes first typed adapters for `common/government_types/*.txt` and `common/government_reforms/*.txt`. The next recommended step is to continue that phase with laws and policies.
